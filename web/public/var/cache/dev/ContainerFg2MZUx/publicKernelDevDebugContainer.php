 ...
 * @final
 */
class publicKernelDevDebugContainer extends Container
{
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'debug.container.dump': $value = ($this->targetDir.''.'/publicKernelDevDebugContainer.xml'); break;
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'publicKernelDevDebugContainer',
            ...
            'router.cache_class_prefix' => 'publicKernelDevDebugContainer',
